...
var AdministrativoService = /** @class */ (function () {
    function AdministrativoService(router) {
        this.router = router;
    }
    AdministrativoService.prototype.canActivate = function (next, state) {
