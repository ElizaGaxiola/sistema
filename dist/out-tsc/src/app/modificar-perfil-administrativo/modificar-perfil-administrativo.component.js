...
var ModificarPerfilAdministrativoComponent = /** @class */ (function () {
    function ModificarPerfilAdministrativoComponent(pf, abc) {
        this.pf = pf;
        this.abc = abc;
    ...
    ModificarPerfilAdministrativoComponent.prototype.iniciar = function () {
        var _this = this;
    ...
    ModificarPerfilAdministrativoComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ModificarPerfilAdministrativoComponent.prototype.onSubmit = function () {
        var _this = this;
    ...
    ModificarPerfilAdministrativoComponent.prototype.saveModsuper = function () {
        var saveModsuper = {
    ...
    ModificarPerfilAdministrativoComponent.prototype.cargandoImagen = function (e) {
        var _this = this;
        var img = e.target;
    ...
    ModificarPerfilAdministrativoComponent = __decorate([
        Component({
    ...
    return ModificarPerfilAdministrativoComponent;
}());
export { ModificarPerfilAdministrativoComponent };
//# sourceMappingURL=modificar-perfil-administrativo.component.js.map